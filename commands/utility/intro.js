...
module.exports = {
    ...
    async execute(interaction) {
        await interaction.reply(`Hello! I am ${interaction.client.user.username}, a bot designed by Nox_Invicte. I am here to assist you with various tasks and provide information. Here are some of my features:
